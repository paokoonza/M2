...
🛡sᴇᴛᴛɪɴɢ ᴄᴍᴅ🛡
✈[Url:on/off]😒ลิ้งห้อง
✈[Autojoin:on/off]😒เข้ากลุ่มอัตโนมัต
✈[Autocancel:on/off😒ออโต้ยกเลิก
✈[Qr:on/off]😒ลิ้งQR
✈[Autokick:on/off]😒ออโต้คลิก
✈[Contact:on/off]😒คอนแทคอ่าน
✈[Status]😒สถานะ
♻️sᴛᴇᴀʟ ᴄᴍᴅ♻️
✈[Steal contact @{name}]😒มิรู้
✈[Steal mid @{name}]😒มิรู้
✈[Steal group pict]😒มิรู้
✈[Steal bio @{name}]😒มิรู้
✈[Steal cover @{name}]😒เอารูป
✈[Steal pict @{name}]😒เอาปก
☣️ᴍᴀʀᴋ ᴛᴏ ʟɪsᴛ ᴄᴍᴅ☣️
✈[Ban @{name}]😒แบน
✈[Unban @{name}]😒ยกเลิกแบน
✈[Ban {send contact}]😒แบนไรมิรู้
✈[Unban {send contact}]😒ยกเลิกแบนมิรู้
✈[Banlist]😒แบนริส
✈[Kick @{name}]😒เตะคน
✈[Kill ban]😒เตะคนที่เราแบนไว้
✈[Spamcontact @{name}]😒สแปมคอนแทค
✈[Copy @{name}]😒ก๊อปปี้
✈[Backup me]😒ออกจากการก๊อปปี้
✈[Gn: {Text}]😒มิรู้
✈[Kick: {mid}😒คิกมิรู้
✈[Invite: {mid}]😒ดึงมิรู้
☔ᴄʜᴀᴛ ʀᴇʟᴀᴛᴇᴅ☔
✈[Wikipedia {text search}]😒มิรู้
✈[Music ]😒ดนตรี
✈[.instagram {username}]😒มิรู้
✈[/say {text}]😒ไว้เล่นคิก
✈[Vidio {text search}]😒มิรู้
✈[Creator]😒คนสร้างคนเขียน
✈[Ginfo]😒เช็คกลุ่มมั้ง
✈[กลุ่มใคร]😒คนสร้างกลุ่ม
✈[Glist]😒มิรู้
✈[Gurl]😒มิรู้
✈[Ourl/Curl]😒มิรู้
✈[แทค]😒แท็กคนทั้งหมด
...
#--------------------------------------------------------
	    elif msg.text in ["กลุ่มใคร","Gcreator","gcreator"]:
		ginfo = cl.getGroup(msg.to)
...
#--------------------------------------------------------
#--------------------------------------------------------
            elif msg.text in ["cancel","ยกเชิญ"]:
                if msg.toType == 2:
...
#--------------------------------------------------------
            elif msg.text in ["แทค","tagall","Tagall","Tag All"]:
...
#--------------------------------------------------------
                ...
                gs = cl.getGroup(msg.to)
                cl.sendText(msg.to,"สวัสดียินดีตอนรับเข้ากลุ่มครับ "+ gs.name)
#--------------------------------------------------------
	    elif "Bc: " in msg.text:
...
#--------------------------------------------------------
                ...
                for i in gid:
                    cl.rejectGroupInvitation(i)
                cl.sendText(msg.to,"ลบคำเชิญเข้าร่วมกลุ่มทั้งหมดแล้วท่าน")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to,"ส่ง คอนแทคมาหำ")

            elif msg.text in ["Unban","ยกแบน"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"ส่งคอนแทคมาหำ")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		for contact in group.members:
			...
			cl.sendText(msg.to, "ยังงมิสมบูรณ์")
		    else:
			pass
...
#--------------------------------------------------------
#Restart_Program
	    elif msg.text in ["Bot:restart","Restart","restart","รีบอท","Bot Restart"]:
